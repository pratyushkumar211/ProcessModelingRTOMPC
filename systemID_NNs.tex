...
\begin{figure}[!h]
  \centering
  \includegraphics[page=9, width=\textwidth]{tworeac_plots_nonlin.pdf}
...
\begin{figure}[!h]
  \centering
  \includegraphics[page=6, width=\textwidth]{tworeac_plots_nonlin.pdf}
...
\begin{figure}[!h]
  \centering
  \includegraphics[page=7, width=\textwidth]{tworeac_plots_nonlin.pdf}
...
\begin{figure}[!h]
  \centering
  \includegraphics[page=8, width=\textwidth]{tworeac_plots_nonlin.pdf}
  \caption{Variation of the cost error metric ($e(C_{Af})$) in the actuator
  constraint set with increase in the training data for the 
