...
from cstr_flash_funcs import plant_ode, greybox_ode, measurement, get_model
from cstr_flash_funcs import get_plant_parameters, get_greybox_parameters
from cstr_flash_funcs import get_rectified_xs
...
def main():
    ...
    # Get parameters.
    plant_pars = get_plant_parameters()
    plant_pars['xs'] = get_rectified_xs(parameters=plant_pars)
