...
from tworeac_funcs import plant_ode, greybox_ode,
from hy import get_model, get_hybrid_pars, hybrid_func
from tworeac_nonlin_funcs import get_economic_opt_pars
from tworeac_nonlin_funcs import get_hybrid_pars_check_func

def get_regulator(model_func, model_pars, model_type,
                   cost_pars, regulator_guess):
